...
async function applyPhase2RLS() {
  console.log('=== Applying Phase 2 RLS Policies to Supabase Database ===');
  ...
  try {
    ...
    console.log(`Executing RLS migration script (${sql.length} bytes)...`);
