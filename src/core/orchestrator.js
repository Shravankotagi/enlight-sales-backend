...
- **VALID NEW INQUIRY**: A New Inquiry requires at minimum: Customer/Company Name AND at least one Product Name (e.g. HR Coil, CR Sheet, GP Sheet, MS Angle, MS Plate, TMT Bar). If the inquiry specifies multiple products (e.g. "GP Sheet 10000 kgs, MS Angle 50x50 15 MT"), all products and line items MUST be recorded. If the message contains only supporting fields (delivery location, rate, payment terms, quantity) without a product name and without an Inquiry ID, prompt the user: "Which inquiry is this for? Please provide the Inquiry ID (e.g. #INQ-XXXXXX) or company name."
