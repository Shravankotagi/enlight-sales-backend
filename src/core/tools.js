...
function createTools(senderPhone, rawUserText = '') {
  ...
  const queryMyDataTool = tool(
    ...
    {
      name: 'query_my_data',
      description: `Use this tool when the salesperson is ASKING for information: outstanding payments, deal pipeline, visit history, KRA performance, customer list, steel rates, sales reports, or any question about existing data.`,
      schema: z.object({
