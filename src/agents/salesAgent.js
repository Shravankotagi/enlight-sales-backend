  ...
  try {
    ...
    try {
      const structuredExtraction = {
        ...
        productType:
          processedItems[0]?.pName || data.product_requirement || null,
      ...
      if (!isPurchaseOrder) {
        if (inqId) {
          ...
          if (inqUpdErr) {
            console.error(
              '[SalesAgent] Error updating inquiry for deal:',
              inqUpdErr,
            );
          }
        } else {
          ...
          if (inqInsErr) {
            ...
            console.log(
              '[SalesAgent] Successfully logged inquiry record for text message:',
              inqId,
            );
          }
        }
      ...
      console.error(
        '[SalesAgent] Inquiries table sync error:',
        inqSyncErr.message,
      );
    }
