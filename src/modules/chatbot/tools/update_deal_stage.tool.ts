...
export const updateDealStageTool: ChatbotTool<UpdateDealStageArgs, any> = {
  ...
  declaration: {
    name: 'update_deal_stage',
    description:
      'Creates a new inquiry or logs customer product requirements (even in conversational or layman phrasing like "Need HR Coil 35 MT for Shree Ganesh Traders"), updates deal rates, quantities, line items, payment terms, delivery location/date, marks deals as won with PO number, or marks deals as lost with reason.',
    parameters: {
      type: 'OBJECT',
      properties: {
        text: {
