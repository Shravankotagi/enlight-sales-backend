...
async function test() {
  ...
  for (const msg of testMessages) {
    ...
    console.log(
      `→ Is complaint: ${isReport} | Is resolution: ${isResolution}\n`,
    );
  }

  console.log('\n=== COMPLAINT LOG TEST ===\n');
  const complaintMsg =
    'ABC Fabricators complaint - they received wrong grade material, ordered MS E250 but got IS 2062, site rejected it completely';
