...
async function test() {
  ...
  const simulatedTranscript = 'bhai Dynamic Industries ka order aaya hai, unhe chahiye 15 MT HR coil 2mm aur 5 MT MS flat 150x6mm, delivery Friday tak Pune mein, payment 30 days';
